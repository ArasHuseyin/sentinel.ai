...
import { GENERIC_NAMES, isGenericName } from './state/generic-names.js';
import { parseWidgetPatterns } from './state/widget-patterns.js';
import { enrichAndDetectRegions } from './state/enrichment.js';
...
export class StateParser {
  ...
  async parse(): Promise<SimplifiedState> {
    ...
    const widgetElements = await parseWidgetPatterns(this.page, counter);
    ...
    await enrichAndDetectRegions(this.page, uiElements);
